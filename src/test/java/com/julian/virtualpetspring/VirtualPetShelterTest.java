...
public class VirtualPetShelterTest {
	...
	OrganicDog newOrganicDog = new OrganicDog(222L, "OrganicDoggo", "is organic dog", 100);
	OrganicDog newOrganicDog2 = new OrganicDog(444L, "OrganicDoggo2", "is organic dog2", 100);
	OrganicCat newOrganicCat = new OrganicCat(111L, "OrganicCat", "is organic cat", 100);
	RoboticDog newRobotDog = new RoboticDog(333L, "RoboticDog", "is robotic dog", 100);
	RoboticCat newRobotCat = new RoboticCat(555L, "RoboticCat", "is robotic cat", 100);
	...
	public void shouldBeAbleToAddAPet() {
		...
		shelter.addPet(new RoboticDog(9090L, "tim", "2020", 100));
