...
public abstract class OrganicPet extends VirtualPet
{
	...
	public OrganicPet(Long id, String name, String description, int health, int hunger, int bladder, int fun, int energy,
			int happiness)
	{
	...
	public OrganicPet(Long id, String name, String description, int health)
	{
		super(id, name, description, health);
	}
